const About = () => {
    return (
        <section className="bg-gray-100 py-16 px-6 md:px-12 lg:px-24 h-screen flex items-center justify-start">
            <div className="max-w-6xl flex flex-col justify-between md:flex-row items-center">

                <div className="md:w-3/5 me-16">
                    <h2 className="text-[42px] font-bold text-[#466233]">
                        QUIÉNES SOMOS
                    </h2>
                    ...
                    <button className="mt-6 bg-amber-300 text-black font-medium py-3 px-6 rounded-lg flex items-center gap-2 shadow-md hover:bg-amber-400 transition">
                        Contáctanos
                        <span>➤</span>
                    </button>
                </div>
