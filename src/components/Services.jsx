    ...
    return (
        <section id="servicios" className="bg-gray-100 py-16 max-w-full mx-auto px-2 sm:px-4 lg:px-20">
            <div className="max-w-7xl mx-auto text-center"> {/* Aumenté el ancho del contenedor principal */}
                <h2 className="text-[42px] font-bold text-[#1b1464]">Servicios</h2>
                ...
                <div className="grid md:grid-cols-3 gap-4"> {/* Reduje el espacio entre columnas (gap) */}
                    ...
                    <div className="bg-white shadow-md p-8">
                        <img src="src/assets/images/caja.jpeg" alt="Cajas de Banano" className="w-[404px] h-[323px] object-cover" />
                    ...
                    {/* Tarjeta 2 */}
                    <div className="bg-white shadow-md p-8">
                        <img src="src/assets/images/proceso-previo.jpeg" alt="Proceso previo al Embarque" className="w-[404px] h-[323px] object-cover" />
                    ...
                    {/* Tarjeta 3 */}
                    <div className="bg-white shadow-md p-8">
                        <img src="src/assets/images/producto-exportacion.jpeg" alt="Producto de Exportación" className="w-[404px] h-[323px] object-cover" />
